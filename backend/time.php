<?
	class timer{
		function time2seconds($time)//time function time2seconds convers HH:MM:SS format 30:15:35 to seconds 
		{//in the database we user this as an integer 
			list($hours, $mins, $secs) = explode(':', $time);//separate by the : and do conversion
			return ($hours * 3600 ) + ($mins * 60 ) + $secs;//then add them all up and return the value calculated
		}
		
		function seconds2time($seconds)//this does the conversion from seconds to time
		{
